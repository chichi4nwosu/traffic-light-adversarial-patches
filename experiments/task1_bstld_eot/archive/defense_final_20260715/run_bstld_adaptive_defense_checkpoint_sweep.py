...
EVALUATOR = (
    ...
    "defense/evaluate_bstld_defended_patch.py"
)

PATCH_DIR = (
    REPO_ROOT
    / "experiments/task1_bstld_eot/"
    "patches/adaptive_defense"
)

WORK_EVALUATOR = (
    REPO_ROOT
    / "experiments/task1_bstld_eot/"
    "evaluation/adaptive_defense/""_adaptive_checkpoint_eval_temp.py"
)

CSV_PATH = (
    REPO_ROOT
    / "experiments/task1_bstld_eot/"
    "evaluation/adaptive_defense/""bstld_eot_adaptive_defense_checkpoint_sweep.csv"
)
...
def main():
    ...
    for epoch in range(1, 6):
        patch_path = (
            "experiments/task1_bstld_eot/"
            "patches/adaptive_defense/"
            f"bstld_eot_adaptive_defense_{epoch}.pt"
        )
